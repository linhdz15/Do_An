                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-10 ">
                                    <div class="form-group row">
                                        <div class="col-lg-8 col-md-8">
                                            ...
                                            <input id="title" type="text" class="form-control" placeholder=""
                                                   value="{{$chapter->title}}" name="title">
                                            @error('title')
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-8 col-md-8">
                                            ...
                                            <select class="form-control" name="status" id="status">
                                                <option value="{{\App\Models\Chapter::DISABLE}}"
                                                        @if($chapter->status == \App\Models\Chapter::DISABLE) selected @endif
                                                >Ẩn
                                                </option>
                                                <option value="{{\App\Models\Chapter::ENABLE}}"
                                                        @if($chapter->status == \App\Models\Chapter::ENABLE) selected @endif
                                                >Hiện
                                                </option>
                                            </select>
                                            @error('status')
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-8 col-md-8">
                                            <label for="type">Lớp học</label>
                                            {{ Form::select('grade_id', [$chapter->grade->id => $chapter->grade->title], $chapter->grade->id, [
                                        ...
                                        <div class="col-lg-8 col-md-8">
                                            <label for="type">Môn học</label>
                                            {{ Form::select('subject_id', [$chapter->subject->id => $chapter->subject->title], $chapter->subject->id, [
                                                'class' => 'form-control input-selected-2',
                                                 'id' => 'subject_id',
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-8 col-md-8">
                                            ...
                                            <input id="seo_title" type="text" class="form-control" placeholder=""
                                                   value="{{$chapter->seo_title}}" name="seo_title">
                                            @error('seo_title')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-lg-8 col-md-8">
                                            ...
                                            <input id="seo_keywords" type="text" class="form-control" placeholder=""
                                                   value="{{$chapter->seo_keywords}}" name="seo_keywords">
                                            @error('seo_keywords')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-16 col-md-16">
                                            ...
                                            <textarea class="form-control" placeholder="Type here" rows="4"
                                                      ...
                                                      id="seo_description">{{$chapter->seo_description}}</textarea>
